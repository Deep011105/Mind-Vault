            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-ink/5 dark:bg-night-raised dark:ring-mist/5">
              ...
              <div className="space-y-4">
                {plan.tasks.map((task) => (
                  <div
                    key={task.id}
                    className={`flex items-start justify-between rounded-xl p-4 transition-colors ${task.status === 'COMPLETED'
              ...
              <div className="space-y-4">
                <div className="rounded-xl bg-moss-50 p-4 dark:bg-moss-900/10">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <SpeakButton text={reflectionResponse.aiResponse} className="text-moss-700 dark:text-moss-300" />
                  </div>
                </div>
              ...
              <form onSubmit={handleReflectionSubmit}>
                <div className="mb-4 flex items-start gap-2">
                  <textarea
                    ...
                    className="min-h-[120px] w-full resize-none rounded-xl bg-ink/5 p-3 text-sm text-ink outline-none transition-colors focus:bg-ink/10 dark:bg-mist/5 dark:text-mist dark:focus:bg-mist/10"
                  />
                  <MicButton value={reflectionText} onChange={setReflectionText} className="mt-1" />
                </div>
                <button
                  type="submit"
                  disabled={reflecting}
